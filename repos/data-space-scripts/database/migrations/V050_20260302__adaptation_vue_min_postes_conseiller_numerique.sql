-- Migration V050: Adaptation de la vue min.postes_conseiller_numerique_synthese
-- Suite à la refonte de la table subvention (V048)
--
-- V048 a supprimé l'ancienne vue avec CASCADE lors de la suppression de source_financement
-- Cette migration la recrée avec la nouvelle structure dénormalisée
--
