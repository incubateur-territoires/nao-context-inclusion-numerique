...
-- vers la clé interne min.utilisateur.id (suite-gestionnaire-numerique#1689).
-- Reprend la migration Prisma du repo MIN :
--   20260807120000_convertir_editeurs_vers_utilisateur_id
