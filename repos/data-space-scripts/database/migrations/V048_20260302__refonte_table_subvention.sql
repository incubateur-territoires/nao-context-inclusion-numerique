-- Migration V048: Refonte de la table subvention
-- Transformation d'un modèle normalisé (plusieurs lignes par poste)
...
-- - dataviz.poste
-- - dataviz.poste_pseudonymisee
-- - min.postes_conseiller_numerique_synthese
-- Les migrations V049 et V050 vont ensuite recréer ces vues avec la nouvelle structure

-- Supprimer la contrainte CHECK sur source_financement
