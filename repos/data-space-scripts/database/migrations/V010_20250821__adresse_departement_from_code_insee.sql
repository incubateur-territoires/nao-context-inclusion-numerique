...
ALTER TABLE main.adresse DROP COLUMN departement;
ALTER TABLE main.adresse ADD COLUMN departement varchar(3) GENERATED ALWAYS AS (CASE WHEN code_insee ~ '^97' OR code_insee ~ '^98' THEN LEFT(code_insee, 3) ELSE LEFT(code_insee, 2) END) STORED;
